...
if(isset($_POST['cancel'])) {
    ...
    if($change) {
        ...
        echo("<script>alert('Đặt thất bại!');</script>"); 
            ...
            <div class="user_center-content g_rel g_right">
                <div class="bookings-container">
                    <div class="booking-list">
                        <a class="booking-item" href="order-all.php"><span class="booking-label">Tất
                                cả</span></a>
                        <a class="booking-item booking-active" href="order-wait.php"><span
                                class="booking-label">Chờ xác nhận</span></a>
                        <a class="booking-item" href="ordered.php"><span class="booking-label">Đã thanh
                                toán</span></a>
                        <a class="booking-item" href="order-cancel.php"><span class="booking-label">Đã
                                Hủy</span></a>
                    </div>
                </div>
                <div class="booking-tour-list">
                    <?php                   
                    $list = $cth->loadBookTourWait($userid);
                                ...
                                <div class="row">
                                    <div class="container-name">
                                        <div class="booking-tour-name">
                                            ...
                                            <div class="booking-status">Đang chờ xác nhận</div>
                                        </div>
