                ...
                <div class="bookings-container">
                    <div class="booking-list">
                        ...
                        <a class="booking-item" href="order-wait.php"><span class="booking-label">Chờ xác
                                nhận</span></a>
                        <a class="booking-item  booking-active" href="ordered.php"><span class="booking-label">Đã thanh toán</span></a>
                        <a class="booking-item" href="order-cancel.php"><span class="booking-label">Đã Hủy</span></a>
                    </div>
                </div>
                <div class="booking-tour-list">
                    <?php                   
                    $list = $cth->loadBookTourOrdered($userid);
                                ...
                                <div class="row">
                                    <div class="container-name">
                                        <div class="booking-tour-name">
                                            ...
                                            if ($book['status']  == 2) {
                                                echo '<div class="booking-status">Đã thanh toán</div>';
                                            }
                                            if ($book['status']  == 3) {
