...
if(isset($_POST['search'])){
    ...
    $flag = false;
    $list = $cth->getSearchTour($textsearch);
}
?>
 <!-- start-content -->
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-sm-5 col-xs-12 mgbs" style="margin-left: 10px;">
                                <div>
                                    ...
                                    <div class="f-left">                                       
                                        <select class="form-control" name="DepartureId" style="width:132px;" data-url="departureID">
                            ...
                            <div class="col-lg-3 text-left mgbs">
                                <div class="f-left">
                                    ...
                                    <div class="f-left">
                                        <select class="form-control Filter" id="priceIDFilter" name="priceID"
                                            data-url="priceID">
